...
namespace RevorbStd
{
    public class Native
    {
        ...
        /// Return Type: void
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_writeinit")]
        public static extern void oggpackB_writeinit(ref oggpack_buffer b);


        /// Return Type: int
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_writecheck")]
        ...
        ///b: oggpack_buffer*
        ///bits: int
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_writetrunc")]
        public static extern void oggpackB_writetrunc(ref oggpack_buffer b, int bits);


        /// Return Type: void
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_writealign")]
        ...
        ///source: void*
        ///bits: int
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_writecopy")]
        public static extern void oggpackB_writecopy(ref oggpack_buffer b, IntPtr source, int bits);


        /// Return Type: void
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_reset")]
        public static extern void oggpackB_reset(ref oggpack_buffer b);


        /// Return Type: void
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_writeclear")]
        ...
        ///buf: void*
        ///bytes: int
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_readinit")]
        ...
        ///value: unsigned int
        ///bits: int
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_write")]
        ...
        ///b: oggpack_buffer*
        ///bits: int
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_look")]
        public static extern int oggpackB_look(ref oggpack_buffer b, int bits);


        /// Return Type: int
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_look1")]
        ...
        ///b: oggpack_buffer*
        ///bits: int
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_adv")]
        public static extern void oggpackB_adv(ref oggpack_buffer b, int bits);


        /// Return Type: void
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_adv1")]
        ...
        ///b: oggpack_buffer*
        ///bits: int
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_read")]
        public static extern int oggpackB_read(ref oggpack_buffer b, int bits);


        /// Return Type: int
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_read1")]
        public static extern int oggpackB_read1(ref oggpack_buffer b);


        /// Return Type: int
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_bytes")]
        public static extern int oggpackB_bytes(ref oggpack_buffer b);


        /// Return Type: int
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_bits")]
        public static extern int oggpackB_bits(ref oggpack_buffer b);


        /// Return Type: void*
        ///b: oggpack_buffer*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "oggpackB_get_buffer")]
        ...
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ogg_stream_iovecin")]
        ...
        /// Return Type: int
        ///os: ogg_stream_state*
        [DllImport("libogg.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ogg_stream_eos")]
        ...
        ///vi: vorbis_info*
        ///zo: int
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_info_blocksize")]
        ...
        ///vc: vorbis_comment*
        ///comment: char*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_comment_add")]
        public static extern void vorbis_comment_add(ref vorbis_comment vc, [In()] [MarshalAs(UnmanagedType.LPStr)] string comment);
        ...
        ///tag: char*
        ///count: int
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_comment_query")]
        public static extern IntPtr vorbis_comment_query(ref vorbis_comment vc, [In()] [MarshalAs(UnmanagedType.LPStr)] string tag, int count);


        /// Return Type: int
        ///vc: vorbis_comment*
        ///tag: char*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_comment_query_count")]
        public static extern int vorbis_comment_query_count(ref vorbis_comment vc, [In()] [MarshalAs(UnmanagedType.LPStr)] string tag);
        ...
        ///v: vorbis_dsp_state*
        ///granulepos: ogg_int64_t->__int64
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_granule_time")]
        public static extern double vorbis_granule_time(ref vorbis_dsp_state v, long granulepos);


        /// Return Type: char*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_version_string")]
        ...
        ///vc: vorbis_comment*
        ///op: ogg_packet*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_commentheader_out")]
        ...
        /// Return Type: int
        ///op: ogg_packet*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_synthesis_idheader")]
        ...
        /// Return Type: int
        ///v: vorbis_dsp_state*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_synthesis_restart")]
        ...
        ///vb: vorbis_block*
        ///op: ogg_packet*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_synthesis_trackonly")]
        ...
        ///v: vorbis_dsp_state*
        ///pcm: float***
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_synthesis_lapout")]
        ...
        ///vi: vorbis_info*
        ///op: ogg_packet*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_packet_blocksize")]
        ...
        ///v: vorbis_info*
        ///flag: int
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_synthesis_halfrate")]
        public static extern int vorbis_synthesis_halfrate(ref vorbis_info v, int flag);


        /// Return Type: int
        ///v: vorbis_info*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_synthesis_halfrate_p")]
        ...
        ///nominal_bitrate: int
        ///min_bitrate: int
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_encode_setup_managed")]
        ...
        ///rate: int
        ///quality: float
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_encode_setup_vbr")]
        ...
        /// Return Type: int
        ///vi: vorbis_info*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_encode_setup_init")]
        ...
        ///number: int
        ///arg: void*
        [DllImport("libvorbis.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "vorbis_encode_ctl")]
